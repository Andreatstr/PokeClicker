...
interface BackgroundMusicProps {
  isDarkMode?: boolean;
  isButton?: boolean;
  // When false, hide UI but keep audio playing
...
export function BackgroundMusic({
  ...
  useEffect(() => {
    ...
    const handleEnded = () => {
      // Set autoplay flag so next track starts automatically
      ...
      {showControls &&
        (isMinimized ? (
          <div
            ...
            className="fixed bottom-4 left-4 w-12 h-12 lg:w-auto lg:h-auto flex items-center justify-center p-2 lg:p-3 border-4 border-gray-300 dark:border-gray-600 rounded lg:rounded z-[10050]"
            style={{
          ...
          <div
            data-onboarding="music-player"
            className="fixed bottom-4 left-4 lg:bottom-4 lg:left-4 flex items-center gap-2 p-3 border-4 border-gray-300 dark:border-gray-600 rounded z-[10050]"
            style={{
              backgroundColor: 'var(--card)',
              color: 'var(--foreground)',
              boxShadow: isDarkMode
